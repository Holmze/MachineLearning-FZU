...
def test_KNN(*data):
    ...
    print('KNN分类器')
    ACC = clusteringMetrics(y_test, y_sample)
...
path_face = 'MachineLearning-FZU\ch3：K-Means\project3_face_images'
path_flower = 'MachineLearning-FZU\ch5：LDA\LDA_dataset_17flowers'
